...
export default {
    ...
    methods: {
        ...
        matrixDataPost: function(url, data) {
            if (data===undefined) data = {};
            data['source'] = this.matrixDataSource;
            return axios.post(url, data);
        },
        gridDataSourcePost: function(url, data) {
            if (data===undefined) data = {};
            data['matrixSource'] = this.matrixDataSource;
            data['gridSource'] = this.gridDataSource;
            return axios.post(url, data);
        },
    },
};
